    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blocked_users', models.ManyToManyField(to=settings.AUTH_USER_MODEL, blank=True)),
                ('company', models.OneToOneField(to='seo.Company')),
                ('customer_of', models.ManyToManyField(related_name='customer', null=True, to='seo.Company', blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='created', to='seo.CompanyUser')),
                ('invoice', models.ForeignKey(to='postajob.Invoice', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(to='postajob.ProductGrouping')),
                ('product', models.ForeignKey(to='postajob.Product')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(to='postajob.Invoice')),
                ('offline_purchase', models.ForeignKey(blank=True, to='postajob.OfflinePurchase', null=True)),
                ('owner', models.ForeignKey(to='seo.Company')),
                ('product', models.ForeignKey(to='postajob.Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(to='seo.Company')),
                ('related_sites', models.ManyToManyField(to='seo.SeoSite', null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, to='seo.Company', help_text=b'The owner of this site package. This should only be used if the site package will be used by the company for partner microsites.', null=True)),
                ('sites', models.ManyToManyField(to='seo.SeoSite', null=True)),
            ],
            options={
            },
