...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BusinessUnit',
            fields=[
                ('id', models.IntegerField(serialize=False, verbose_name=b'Business Unit Id', primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ats_source_codes', models.ManyToManyField(to='seo.ATSSourceCode', blank=True)),
                ('billboard_images', models.ManyToManyField(to='seo.BillboardImage', blank=True)),
                ('business_units', models.ManyToManyField(to='seo.BusinessUnit', blank=True)),
        ...
        migrations.AddField(
            model_name='seosite',
            name='facets',
            field=models.ManyToManyField(to='seo.CustomFacet', through='seo.SeoSiteFacet', blank=True),
        ),
        migrations.AddField(
            model_name='seosite',
            name='featured_companies',
            field=models.ManyToManyField(to='seo.Company', blank=True),
        ),
        migrations.AddField(
            model_name='seosite',
            name='google_analytics',
            field=models.ManyToManyField(to='seo.GoogleAnalytics', blank=True),
        ),
        migrations.AddField(
            model_name='seosite',
