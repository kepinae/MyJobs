    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_packages', models.ManyToManyField(to='postajob.SitePackage', null=True, blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keyword', taggit.managers.TaggableManager(to='taggit.Tag', through='taggit.TaggedItem', help_text='A comma-separated list of tags.', verbose_name='Tags')),
            ],
            options={
                'abstract': False,
            },
